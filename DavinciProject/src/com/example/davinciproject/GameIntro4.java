...
public class GameIntro4 extends Activity {
	ViewPager pager;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		GameIntro5 adapter= new GameIntro5(getLayoutInflater());
	...
	public void mOnClick(View v){
		int position;
		switch( v.getId() ){
		case R.id.btn_previous2://이전버튼 클릭
		...
		case R.id.btn_next2://다음버튼 클릭
			...
			break;
		case R.id.back2:
			Intent Back = new Intent(getApplicationContext(), GameIntro1.class);
			startActivity(Back);
			break;
		}
	}
